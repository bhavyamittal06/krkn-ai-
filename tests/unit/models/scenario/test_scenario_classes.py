...
from krkn_ai.models.cluster_components import ClusterComponents, Namespace, Pod, Container, Node, Service, ServicePort, PVC
...
class TestPodScenario:
    ...
    def test_pod_scenario_initialization_with_valid_pods(self):
        ...
        assert "app=" in scenario.pod_label.value or "version=" in scenario.pod_label.value
    ...
    def test_pod_scenario_raises_error_when_no_pods_with_labels(self):
        ...
        with pytest.raises(ScenarioParameterInitError, match="No pods found with labels"):
...
class TestNetworkScenario:
    ...
    def test_network_scenario_raises_error_when_no_nodes_with_interfaces(self):
        ...
        with pytest.raises(ScenarioParameterInitError, match="No nodes found with interfaces"):
...
class TestSynFloodScenario:
    ...
    def test_syn_flood_scenario_raises_error_when_no_services_with_ports(self):
        ...
        with pytest.raises(ScenarioParameterInitError, match="No services with ports found"):
