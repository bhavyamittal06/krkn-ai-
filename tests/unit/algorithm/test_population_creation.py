...
class TestPopulationCreation:
    ...
    def test_create_population_with_valid_size(self, genetic_algorithm):
        ...
        with patch('krkn_ai.algorithm.genetic.ScenarioFactory.generate_random_scenario') as mock_gen_scenario:
    ...
    def test_create_population_handles_insufficient_unique_scenarios(self, genetic_algorithm):
    ...
    def test_create_population_raises_error_when_no_available_scenarios(self, genetic_algorithm):
        ...
        with patch('krkn_ai.algorithm.genetic.ScenarioFactory.generate_random_scenario') as mock_gen_scenario:
            ...
            with pytest.raises(UniqueScenariosError, match="Please adjust population size"):
